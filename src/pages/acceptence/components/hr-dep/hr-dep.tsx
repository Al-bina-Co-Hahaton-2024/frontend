            ...
            <div className={'flex items-center justify-between'}>
                <div className={'flex items-center gap-[15px] bg-[#FFA842] rounded-[50px] pt-[5px] pr-[15px] pb-[5px] pl-[15px]'}>
                    ...
                    <span className={'w-[20px] h-[20px] rounded-[50%] bg-white text-black text-center overflow-hidden'}>
                        <div className={'text-sm'}>{hrDocs.length}</div>
                    </span>
                </div>
                    ...
                    {hrDocs.map((doctor, index) => (
                        ...
                        >
                            ...
                            <div className={'flex flex-col'}>
                                ...
                                <div className={'flex items-center gap-[15px] bg-[#FFA842] hover:bg-[#FFA980] transition duration-500 ease-in-out rounded-[50px] py-[6px] px-[15px] max-w-[277px] mt-[10px] cursor-pointer'}>
                                    <img src={eye} alt={'eye'} />
